module ForemanRhCloud
  class TagsAuth
    ...
    def update_tag
      cached = Rails.cache.read(sync_identity)
      return cached if cached

      Foreman::AdvisoryLockManager.with_session_lock(sync_identity) do
        Rails.cache.fetch(sync_identity, expires_in: SYNC_CACHE_TTL) do
    ...
    def sync_identity
      "rh_cloud_tags_auth_sync_#{tag_value}"
    end
  end
end
