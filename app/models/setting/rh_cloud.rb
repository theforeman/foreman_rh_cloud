class Setting::RhCloud < Setting
  def self.default_settings
    ...
    [
      ...
      set('rh_cloud_token', N_('Authentication token to RH cloud services. Used to authenticate requests to Red Hat cloud APIs'), 'DEFAULT', N_('RH Cloud token'), nil, { encrypted: true }),
    ]
  end
