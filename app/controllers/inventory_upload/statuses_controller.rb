module InventoryUpload
  class StatusesController < ::ApplicationController
    ...
    def index
      ...
      statuses = Hash[
        portal_users.map do |portal_user|
          generate_report_status = status_for(portal_user, InventoryUpload::Async::GenerateReportJob)
          upload_report_status = status_for(portal_user, InventoryUpload::Async::UploadReportJob)
    ...
    def status_for(portal_user, job_class)
      ...
      InventoryUpload::Async::ProgressOutput.get(label)&.status
    end
  end
end
