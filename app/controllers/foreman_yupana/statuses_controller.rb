module ForemanYupana
  class StatusesController < ::ApplicationController
    ...
    def index
      ...
      statuses = Hash[
        portal_users.map do |portal_user|
          generate_report_status = status_for(portal_user, ForemanYupana::Async::GenerateReportJob)
          upload_report_status = status_for(portal_user, ForemanYupana::Async::UploadReportJob)
    ...
    def status_for(portal_user, job_class)
      ...
      ForemanYupana::Async::ProgressOutput.get(label)&.status
    end
  end
end
